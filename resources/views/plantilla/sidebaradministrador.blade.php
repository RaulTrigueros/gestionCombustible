    ...
    <ul class="nav">
      ...
      <li class="nav-item nav-dropdown" >
        <a class="nav-link nav-dropdown-toggle" href="#">
          <i class="nav-icon fa fa-handshake-o"></i>Gestion Combustible</a>
        <ul class="nav-dropdown-items">
         ...
         <!-- <li class="nav-item nav-dropdown">
            <a class="nav-link nav-dropdown-toggle" href="#">
              <i class="nav-icon fa fa-product-hunt"></i>Proyectos</a>
              <ul class="nav-dropdown-items">
                <li class="nav-item">
                  <a class="nav-link" @click="menu=20" href="#">
                    <i class="nav-icon fa fa-product-hunt"></i>Proyectos</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" @click="menu=21" href="#">
                    <i class="nav-icon fa fa-address-book"></i>Encargados</a>
                </li>
              </ul>
          </li>-->
        </ul>
      ...
      <li class="nav-item nav-dropdown">
        <a class="nav-link nav-dropdown-toggle" href="#">
          <i class="nav-icon fa fa-info-circle"></i>Publicidad</a>
        <ul class="nav-dropdown-items">
          <li class="nav-item">
            <a class="nav-link" @click="menu=2" href="#">
              <i class="nav-icon fa fa-info"></i>Anuncios</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" @click="menu=7" href="#">
              <i class="nav-icon fa fa-info"></i>Noticias</a>
          </li>
