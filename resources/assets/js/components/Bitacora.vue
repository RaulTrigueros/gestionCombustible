            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-sm table-responsive">
                        <thead>
                        <tr>
                            <th style="vertical-align:middle; width: 20%; ">Usuario</th>
                            <th style="vertical-align:middle; width: 25%;">Acción</th>
                            <th style="vertical-align:middle; width: 25%;">Tabla</th>
                            <th style="vertical-align:middle; width: 30%;">Fecha</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr v-for="bitacora in arrayBitacora" :key="bitacora.id">
                            <td class="align-middle" v-text="bitacora.usuario"></td>
                            <td class="align-middle" v-text="bitacora.accion"></td>
                            <td class="align-middle" v-text="bitacora.tabla"></td>
                            <td class="align-middle" v-text="bitacora.fecha"></td>
                        </tr>
                        </tbody>
                    </table>
                    <nav>
