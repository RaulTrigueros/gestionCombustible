                        ...
                        <table class="table table-bordered table-striped table-sm table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th style="vertical-align:middle;">Número de Documento</th>
                            ...
                            <tbody>
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                      <td class="align-middle" align="center">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" @click="eliminarUsuario(persona.id)">
                                    ...
                                    <td class="align-middle" v-text="persona.tipo_documento"></td>
                                    <td class="align-middle" v-text="persona.num_documento"></td>
                                    <td class="align-middle" v-text="persona.direccion"></td>
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="modalRegistro" v-text="tituloModal"></h4>
                        ...
                        <div class="modal-body" style="padding:1em">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="num_documento" maxlength="10" class="form-control" placeholder="Número de documento">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select v-model="cargo" class="form-control">
                                            ...
                                            <option value="Tesorera">Tesorería</option>
                                            <option value="Presupuesto">Presupuesto</option>
                                            <option value="UACI">UACI</option>
                                            <option value="Colecturía">Colecturía</option>
                                            <option value="Registro Familiar">Registro Familiar</option>
                                            <option value="Catastro">Catastro</option>
                                            <option value="Cuentas Corriente">Cuentas Corriente</option>
                                            <option value="Comunicaciones">Comunicaciones</option>
                                            <option value="Unidad de Género">Unidad de Género</option>
                                            <option value="Medio Ambiente">Medio Ambiente</option>
                                            <option value="Deporte y Recreacion">Deporte y Recreación</option>
                                            <option value="UAIP">UAIP</option>
                                            <option value="Servicios Generales">Servicios Generales</option>
                                            <option value="Recepcionista">Recepcionista</option>
                                            <option value="Gerencia">Gerencia</option>
                                            <option value="Recursos Humanos">Recursos Humanos</option>
                                            <option value="Administración Agua">Administración Agua</option>
                                            <option value="Promoción Social">Promoción Social</option>
                                        </select>                                    
                                    </div>
                                </div>
                        ...
                        <div class="modal-body" style="padding:1em">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                               ...
                               <!-- <div class="form-group row">
                                ...
                                <div v-show="errorPersona" class="form-group row div-error">
                                    <div class="text-center text-error">
                                        <div v-for="error in errorMostrarMsjPersona1" :key="error" v-text="error">
    ...
    export default {
        ...
        methods : {
            ...
            validarPersona(){
                ...
                if (this.role_id==0) this.errorMostrarMsjPersona.push("Debes seleccionar un rol para el usuario.");
            ...
            validarPersona1(){
                this.errorPersona=0;
                this.errorMostrarMsjPersona1 =[];
               
                if (!this.nombre) this.errorMostrarMsjPersona1.push("El nombre de la persona no puede estar vacío.");
                if (!this.usuario) this.errorMostrarMsjPersona1.push("El nombre de usuario no puede estar vacío.");
                if (this.role_id==0) this.errorMostrarMsjPersona1.push("Debes seleccionar un rol para el usuario.");
            
                if (this.errorMostrarMsjPersona1.length) this.errorPersona = 1;
