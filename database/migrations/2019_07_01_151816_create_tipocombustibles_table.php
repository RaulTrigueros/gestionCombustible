...
class CreateTipocombustiblesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tipocombustibles', function (Blueprint $table) {
         ...
         DB::table('tipocombustibles')->insert(array('id'=>'32','nombequipo'=>'16 - Fumigación','descripcionequipo'=>'Uso de maquinarias para fumigación'));
         DB::table('tipocombustibles')->insert(array('id'=>'33','nombequipo'=>'Camión de Volteo Blanco - Placa N19196','descripcionequipo'=>'Camión Municipal para recolección de basura'));
